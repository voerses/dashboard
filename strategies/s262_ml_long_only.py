"""Strategy S262: ML Direction Long-Only with Fixed Hold (Perp, 2x)
=================================================================
LONG-only ML direction strategy. Key findings:
- LONG p>=0.65: 67.2% win rate, +4.07% avg profit in last 12 months
- SHORT signals degraded to 18% precision - excluded
- Fixed ~24h hold to match prediction horizon
"""
import numpy as np
import pandas as pd
import joblib
...
def strategy(ctx: StrategyContext) -> StrategyResult:
    ...
    # LONG-ONLY: p>=0.60 for more signals (62.8% win, +2.87% avg)
    # p>=0.65 is better precision but fewer signals
    ...
    return StrategyResult(
        ...
        no_stop_bars=24,      # No stop for prediction horizon
        ...
        exchange='binance', name='s262_ml_long_only')

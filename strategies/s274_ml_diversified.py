"""Strategy S274: ML Direction Diversified Long-Only (Perp, 1x)
=============================================================
Small positions + many concurrent trades + no stops + 24h hold.
Diversification replaces stops for risk management.
Edge=0.30 for smaller positions, allowing 15 concurrent positions.
"""
import numpy as np
import pandas as pd
import joblib
...
def strategy(ctx: StrategyContext) -> StrategyResult:
    ...
    return StrategyResult(
        ...
        edge=0.30,            # SMALL positions = more diversification
        exit_regimes=set(),   # No regime exits
        breakeven_atr=999.0,
        max_trade_pct=0.08,   # Max 8% of capital per trade
        conviction_score=conviction,
        exchange='binance', name='s274_ml_diversified')

...
#
S523w — Hybrid Regime (hardcoded years + SMA50 intra-year)
=============================================================
...
def strategy(ctx: StrategyContext) -> StrategyResult:
    ...
    # Hybrid regime: hardcoded bear years + SMA50 intra-year override
    # Hardcoded: captures full-year bears (2022, 2025, 2026)
    # SMA50: catches intra-year dips in bull years (e.g., 2024 Aug-Sep)
    ...
    _bear_regime = _bear_years | _sma50_bear  # OR: either signal triggers bear
    _sof = np.where(_bear_regime, True, _short_ok)

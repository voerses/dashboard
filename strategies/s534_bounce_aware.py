"""
S534 — Bounce-Aware (reduce shorts in bear bounce) (bear-long stop 3.5 ATR + 24h Sharpe exit)
...
BACKTEST CLI:
  /workspace/venv/bin/python v4/portfolio_backtest.py \\
      --strategy s534_bounce_aware --months 12 --capital 100000 \\
...
def _compute_token_signal(ctx) -> StrategyResult:
    ...
    # BEAR BOUNCE DETECTION: in sustained bear but BTC is rallying above SMA50
    # This is the danger zone for short-heavy strategy (shorts get squeezed).
    ...
    _sustained_above_s50 = _above_s50_count > 7 * 24
    _bear_bounce = _sustained_bear & _sustained_above_s50

    # During bear bounce: reduce leverage to 1.5x (from 3x) for shorts

...
def strategy(ctx: StrategyContext) -> StrategyResult:
    ...
    return StrategyResult(
        ...
        leverage=5.0, stop_mult=3.0, trail_mult=3.0, target_mult=999,
        no_stop_bars=24, min_hold=18, max_hold=720,
        edge=0.6, exit_regimes={CRISIS},
        breakeven_atr=0.8, max_trade_pct=0.25,
        exchange="binance", name="s224_lev_test")

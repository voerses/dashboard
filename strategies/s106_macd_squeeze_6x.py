"""
s106 MACD Squeeze 6x — Leverage-calibrated s102

s102 achieved: +400.0% return, MaxDD -22.6%, Calmar 5.45 at 7x leverage
Math: Scale leverage to 6x (85.7% of 7x)
  - Expected return: ~343% (still > 300%)
  - Expected DD: ~19.4% (< 20% target)
  - Expected Calmar: ~5.45 (unchanged, both scale equally)

Changes from s102:
  1. LEVERAGE: 6.0x (from 7.0x) — simple proportional DD reduction
  2. BREAKEVEN RATCHET + VOL SCALING: Kept from s102
  3. All signals IDENTICAL
...
# ── Configuration ────────────────────────────────────────────────
LEVERAGE = 6.0                   # Calibrated down (s98/s102 = 7.0)
WARMUP = 200
...
# Trade management (same as s98/s102)
STOP_MULT = 99.0
TRAIL_MULT = 2.5
TARGET_MULT = 999.0
NO_STOP_BARS = 72
...
def strategy(ctx: StrategyContext) -> StrategyResult:
    """MACD squeeze at 6x leverage for DD control."""

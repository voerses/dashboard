"""
s160 Volatile Funding L/S — More Shorts — V4 Portfolio Strategy (Class B)

Recycle of s151: increase N_SHORT from 5 to 7.
Sensitivity analysis showed N_SHORT=7 was the best single-param variant
(Calmar +26% vs baseline, Sharpe 1.24, return +33.6%).

Hypothesis: funding signal is stronger on the short side (crowded longs
pay high funding → short them). More shorts captures more of this edge.
...
def strategy(contexts: dict) -> dict:
    """Cross-sectional funding L/S on volatile tokens — more shorts."""
    token_data = {}

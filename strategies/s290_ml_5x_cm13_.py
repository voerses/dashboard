"""Strategy S290: ML 5x Aggressive (Long, Perp, 5x, cap_mult=2.0)
====================================================================
...
def strategy(ctx: StrategyContext) -> StrategyResult:
    ...
    if token and token not in _WHITELIST:
        return StrategyResult(
            ...
            cap_multiplier=1.3, max_trade_pct=0.50,
            exchange='binance', name='s290_ml_5x_cm13')
    ...
    return StrategyResult(
        ...
        exit_regimes=set(),
        breakeven_atr=999.0,
        cap_multiplier=1.3,       # 1.3x position size cap

# ============================================================
# s513a — Triple-Trigger Regime Swing (3x: +216%, 4x variant: +303%)
# ============================================================
#
# FROZEN COPY of s513_triple_trigger_swing.py with documentation.
# Strategy code is IDENTICAL — only this comment block differs.
#
# REPRODUCE THE RESULT:
#   /workspace/venv/bin/python v4/portfolio_backtest.py \
#       --strategy s513a --months 12 --capital 50000 \
#       --market perp --conviction-mode ranked \
#       --max-portfolio-positions 15 --concentration 0.20 --skip-wf
#
# Verified L12M (rolling, results shift with new data):
#   +303% requires s513v_lev4_0 (4x leverage). This file is 3x: +216% / Sharpe 2.71 / MaxDD -16.7%
#   (at data end ~2026-04-05 15:00 UTC)
#
# Key portfolio settings (NOT in strategy code):
#   --capital 50000          smaller capital = bigger % per trade
#   --concentration 0.20     up to 20% of capital per position
#   --max-portfolio-positions 15   fewer concentrated bets
#   --skip-wf                matches paper trader (no future to mask)
#
# Leverage variants: s513_lev3_5.py, s513_lev4_0.py, s513_lev5_0.py
# ============================================================

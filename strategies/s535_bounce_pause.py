...
BACKTEST CLI:
  /workspace/venv/bin/python v4/portfolio_backtest.py \\
      --strategy s535_bounce_pause --months 12 --capital 100000 \\
...
def _compute_token_signal(ctx) -> StrategyResult:
    ...
    # BEAR BOUNCE: pause entries when BTC rallies during sustained bear
    # Detect: sustained bear AND BTC > SMA50 for 7+ days continuous
    ...
    # Block ALL entries during bear bounce
    entry[_bear_bounce] = False
    direction[_bear_bounce] = 0

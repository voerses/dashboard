...
DIRECTION = "short"         # SHORT-ONLY (optimized separately)

# -- Trade management (SHORT-OPTIMIZED) --
LEVERAGE = 3.0
STOP_MULT = 2.5             # hard stop (rarely hit)
TRAIL_MULT = 4.0            # wider trail for shorts — lets liquidation cascades run

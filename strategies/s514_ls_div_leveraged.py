...
def _get_divergence_aligned(symbol: str, idx_1h: pd.DatetimeIndex) -> np.ndarray:
    ...
    BIAS FIX (2026-04-04): Daily L/S metric for date D covers 00:00-23:55 UTC
    and is NOT available until D+1 00:00. Shift daily index by +1 day so that
    day D's value is only used starting at D+1 bars.
    """

...
DIRECTION = "long"          # LONG-ONLY (optimized separately)

# -- Trade management (LONG-OPTIMIZED) --
LEVERAGE = 3.0
STOP_MULT = 2.5             # hard stop (rarely hit)
TRAIL_MULT = 2.5            # tighter trail for longs — short squeezes resolve faster

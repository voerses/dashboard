"""
S521 — Adaptive Per-Token Composite Positioning
================================================

Evolved from s520. Key improvements over s520:
...
# -- Trade management --
LEVERAGE = 2.0                # optimized from sweep (2.5x best Calmar but 2.0 safer)
STOP_MULT = 8.0               # wide stop for mean-reversion
...
# -- Token blacklist: worst 15 value-destroying tokens from L12M sweep --
# Conservative list: only tokens with >$5K losses AND 3+ trades
TOKEN_BLACKLIST = {

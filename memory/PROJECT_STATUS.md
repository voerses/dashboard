...
> **Last updated:** 2026-03-16T23:30Z
...
| Circuit Breaker (4R) | `v4/simulator.py` | Emergency exit during no_stop_bars window when position loses >=4x initial_risk. A/B tested R=2,3,4,5 across 4 strategies. R=4.0 optimal: 71-113% return retention. PIPPIN -45% crash was catalyst. |
...
| **HIGH** | Pump-and-dump entry detection | None | 3-layer approach: (1) Composite Volume-Volatility Anomaly Score — blocks entry when pump_risk>0.6, (2) ADV-Tiered Sizing — aggressive penalty for low-ADV tokens, (3) Funding Rate z-score>3.0 blocks LONG entries. PIPPIN crash (-45%, -$63K) was the catalyst. Research in `memory/DEV_SESSION_2026-03-16_circuit_breaker.md`. Est. 2-5% backtest cost. |

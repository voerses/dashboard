...
def _serialize_position(pos: Position) -> dict:
    ...
    d = {
        ...
        "exit_regimes_long": sorted(pos.exit_regimes_long),
        "exit_regimes_short": sorted(pos.exit_regimes_short),
        "regime_exit_min_bars": int(pos.regime_exit_min_bars),
...
def _deserialize_position(d: dict) -> Position:
    ...
    pos = Position(
        ...
        exit_regimes_long=set(d.get("exit_regimes_long", [])),
        exit_regimes_short=set(d.get("exit_regimes_short", [])),
        regime_exit_min_bars=d.get("regime_exit_min_bars", 6),

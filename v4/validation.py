...
from v4.metrics import (
    PerformanceMetrics, compute_metrics, build_equity_curve,
    load_benchmark_returns,
)
from v4.cpcv import generate_cpcv_splits, deflated_sharpe
from v4.universe import get_all_tradeable, resolve_universe
...
def _run_cpcv_v4(strategy_id: str, ticker: str,
    ...
    for train_idx, test_idx in splits:
        ...
        from v4.signals import TokenSignals, _to_array, _copy_f32
        from v4.universe import get_fee_rate, get_maint_margin_rate
        ...
        ts = TokenSignals(
            ...
            size_multiplier=_to_array(result.size_multiplier, fold_len),
            cap_multiplier=_to_array(result.cap_multiplier, fold_len),
            leverage=_to_array(result.leverage, fold_len),
            max_trade_pct=float(result.max_trade_pct),

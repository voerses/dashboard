...
def _get_append_rebalances():
    from v5.paper_state import append_rebalances
    return append_rebalances

def _get_truncate_after_tick():
    from v5.paper_state import truncate_after_tick
    return truncate_after_tick

def _get_read_trades_jsonl():
    from v5.paper_state import read_trades_jsonl
...
def _get_deserialize_engine_state():
    from v5.paper_state import deserialize_engine_state
